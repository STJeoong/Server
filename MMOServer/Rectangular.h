...
{
public:
	Rectangular(int offsetY, int offsetX, int yExtension, int xExtension) : _offsetY(offsetY), _offsetX(offsetX), _yExtension(yExtension), _xExtension(xExtension) {}
