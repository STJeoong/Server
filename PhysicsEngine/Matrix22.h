...
public:
	...
	Matrix22 transpose() const { Matrix22 ret = { _m00, _m10, _m01, _m11 }; ret._radian = -_radian; return ret; }
	Matrix22 absolute() const { return { abs(_m00), abs(_m01), abs(_m10), abs(_m11) }; }
